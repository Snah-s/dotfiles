...
local mainAlt = "ALT" -- Sets "ALT" key as alternative modifier
local mainCtrl = "CTRL" -- Sets "CTRL" as control modifier
...
-- Panel de ajustes (batería, pantalla, fondo, wifi, atajos)
